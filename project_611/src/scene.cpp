...
void Scene::LoadScene() {
	...
	RenderData cloppeuxSprite2 = { glm::vec2(10,0), glm::vec2(50, 50), glm::vec2(16, 0), glm::vec2(16, 16), 0.0 };
...
void Scene::createPlayerGameObject(const std::string& name, glm::vec2 playerPos)
{
	...
	RenderData playerSprite = { playerPos, glm::vec2(50, 50), glm::vec2(0, 0), glm::vec2(16, 16), 1.0 };
