...
void Scene::LoadScene() {
	...
	RenderData cloppeuxSprite = { glm::vec2(0,0), glm::vec2(700, 500), glm::ivec2(1024, 1024), glm::ivec2(1024, 1024), 0.0 };
	...
	//RenderData cloppeuxSprite3 = { glm::vec2(50,150), glm::vec2(50, 50), glm::ivec2(48, 0), glm::ivec2(16, 16), 0.75 };
