...
//    resource_manager::GetShader("sprite").SetInteger("image", 0, resource_manager::GetShader("sprite").fragmentShaderProgram);
//    resource_manager::GetShader("sprite").SetMatrix4("projection", projection, resource_manager::GetShader("sprite").vertexShaderProgram);
